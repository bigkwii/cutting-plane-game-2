...
var FORGIVENESS_SNAP_EPSILON = GEOMETRY_EPSILON * 1000
var FORGIVENESS_COLINEAR_EPSILON = GEOMETRY_EPSILON * 10
var FORGIVENESS_MERGE_EPSILON = GEOMETRY_EPSILON * 10