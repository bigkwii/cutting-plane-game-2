...
## [br][br]
## !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
## !!! TODO: move things from the testing scene here, and decide which ones go on the polygon scene !!!
## !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
func _ready():
	if level_json_filename == "":
		level_json_filename = DEFAULT_LEVEL
	var level_json_path = LEVELS_DIR + level_json_filename + ".json"
	...
	POLYGON.rebuild_polygon(POLYGON.initial_vertices)
